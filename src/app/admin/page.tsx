    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6 pb-24">
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={handleLogout} className="p-2 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-red-500 hover:border-red-200 transition-all">
                    <LogOut size={20} />
                </button>
            </div>

            <div className="grid grid-cols-2 gap-4">
                <Link href="/admin/qr-generator" className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xl shadow-blue-900/5 hover:border-blue-200 hover:-translate-y-1 transition-all group">
                ...
                <Link href="/admin/users" className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xl shadow-blue-900/5 hover:border-blue-200 hover:-translate-y-1 transition-all group">
                ...
                <Link href="/admin/payouts" className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xl shadow-blue-900/5 hover:border-blue-200 hover:-translate-y-1 transition-all group">
                ...
                <Link href="/admin/logs" className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xl shadow-blue-900/5 hover:border-blue-200 hover:-translate-y-1 transition-all group">
