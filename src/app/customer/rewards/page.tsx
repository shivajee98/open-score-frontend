...
export default function RewardsPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 pb-24 font-sans">
            {/* Header */}
            <div className="bg-gradient-to-br from-rose-600 to-pink-700 p-6 pt-12 pb-20 rounded-b-[2.5rem] shadow-xl shadow-rose-900/20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <button onClick={() => router.back()} className="mb-6 text-white/80 hover:text-white transition-colors">
                        <ArrowLeft size={24} />
                    </button>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 mt-8">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-4xl font-black text-white tracking-tight">₹{totalEarned}</p>
                            </div>
            ...
            <div className="px-6 -mt-10 relative z-20">
                <div className="bg-white rounded-[2rem] shadow-xl shadow-slate-900/5 p-6 border border-slate-100">
                            ...
                            {rewards.map((reward) => (
                                <div key={reward.id} className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                    ...
                                    <div className="text-right">
                                        <p className="font-black text-lg text-emerald-600">₹{reward.amount}</p>
                                        <p className={cn(
                ...
                {/* How to Earn More */}
                <div className="mt-6 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-blue-900/20">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-blue-400/20 rounded-full blur-2xl"></div>
                    <div className="relative z-10">
                        <h3 className="text-xl font-black mb-4 tracking-tight">Earn More Rewards</h3>
