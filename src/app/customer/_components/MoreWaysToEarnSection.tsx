      ...
      <div className="grid grid-cols-4 gap-1.5 pb-3">
        {ways.map(way => (
          <Link 
            ...
            className={`bg-white border border-slate-100/80 shadow-[0_4px_12px_rgba(0,0,0,0.015)] rounded-[12px] p-2 flex items-center justify-between h-[52px] group transition-all relative overflow-hidden ${
          ...
          >
            <div className="flex flex-col justify-center min-w-0 pr-1 z-10">
              <div className="flex items-center gap-1">
                ...
                {way.comingSoon && (
                  <span className="text-[5px] font-black bg-amber-50 text-amber-600 border border-amber-100 px-0.5 rounded uppercase leading-none shrink-0 scale-90">Soon</span>
                )}
              </div>
