                ...
                <section>
                    ...
                    {activeLoans.length > 0 ? (
                        ...
                        <div className="p-12 text-center bg-white rounded-2xl border border-dashed border-slate-200 shadow-sm">
                            ...
                            <button onClick={() => router.push('/customer/loan')} className="mt-6 px-6 py-2.5 bg-blue-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-blue-500/20 hover:scale-105 transition-transform active:scale-95">
                                Explore Loan Offers
                            </button>
                        </div>
                    )}
