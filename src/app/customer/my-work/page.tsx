                            ...
                            <div className="bg-white relative overflow-hidden print:hidden" style={{ width: '210mm', minHeight: '297mm' }}>
                                <div className="p-16 text-slate-900 font-serif leading-relaxed relative h-full">
                                    ...
                                    <div className="relative z-10 text-[13px] font-sans text-slate-700 text-justify mb-8 space-y-5 leading-relaxed">
                                        ...
                                        <p>
                                            The Agent shall act as an independent individual and may engage or manage a team at their own discretion and expense. The Company shall only pay the commission/incentive amount displayed in the Open Score platform, and shall not be responsible for any employment, payment, liability, or obligations related to the Agent's  team members.
                                        </p>
                                    </div>
