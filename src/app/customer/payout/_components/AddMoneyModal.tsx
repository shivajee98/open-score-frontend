      ...
      <div className="bg-white border border-slate-100 w-full max-w-sm rounded-[2rem] p-6 shadow-2xl relative text-slate-900 max-h-[90vh] overflow-y-auto">
        ...
        {Number(addMoneyAmount) > 0 && (
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[11px] font-black text-amber-500 mt-0.5 italic">
                    Split Payment
                  </p>
                </div>
              </button>
            ...
            {addMoneySource === "HYBRID" && (
              <div className="bg-amber-50 border border-amber-100 p-4 rounded-2xl flex gap-3 text-left mb-2">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-slate-500 font-semibold">
                    Wallet Balance (<span className="text-slate-900 font-bold">{walletBalance.toLocaleString("en-IN")}</span>) will be used.
                    Please pay the remaining <span className="text-[#6246EA] font-bold">{(Number(addMoneyAmount) - walletBalance).toLocaleString("en-IN")}</span> via UPI below.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100 animate-in fade-in duration-300">
                <div className="flex flex-col items-center">
                  <div className="p-3 bg-white rounded-2xl shadow-xl mb-3 border border-slate-100">
                    <QRCodeSVG
                      value={`upi://pay?pa=${upiId}&pn=Flip%20Flops&am=${
                        addMoneySource === "HYBRID"
                          ? Number(addMoneyAmount) - walletBalance
                          : addMoneyAmount
                      }&tn=Vault%20Card%20TopUp`}
                      size={120}
                      level="M"
                    />
                  </div>
            ...
            <button
              ...
              disabled={
                ...
                ((addMoneySource === "UPI" || addMoneySource === "HYBRID") && !addMoneyProof)
              }
