...
export default function VaultCard({
  ...
  const isMaximized =
    controlledMaximized !== undefined ? controlledMaximized : internalMaximized;
  ...
  const showCardNumber =
    controlledShowCardNumber !== undefined
      ? controlledShowCardNumber
      : internalShowCardNumber;
  ...
  const showCvc =
    controlledShowCvc !== undefined ? controlledShowCvc : internalShowCvc;
  ...
  return (
    <div
      className={`relative w-full h-[195px] perspective-1000 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] cursor-pointer select-none ${
        isMaximized
          ? "scale-[1.2] md:scale-[1.35] shadow-2xl z-30"
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              ...
              <div className="flex items-start justify-between">
                <div className="flex flex-col gap-0">
                  <div className="flex items-center gap-2">
                    <div className="flex flex-col">
                      <span className="text-[11px] font-black tracking-[0.1em] text-[#c5a059] uppercase leading-none">
                        OPEN SCORE
                      </span>
                      <span className="text-[5px] font-bold text-[#c5a059]/60 uppercase tracking-widest mt-0.5">
                        SMART VALUE
                      </span>
                    </div>
                  </div>
                ...
                <div className="text-right flex flex-col items-end">
                  <span className="text-[6px] font-black text-[#c5a059]/80 uppercase tracking-[0.2em] leading-none">
                    PREMIUM METAL CARD
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 mt-1">
                ...
                {/* Wireless icon */}
                <svg
                  className="w-4 h-4 text-[#c5a059]/80 rotate-90 transform shrink-0"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.5"
              ...
              <div className="mt-1 flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="text-[6.5px] font-black uppercase tracking-widest text-[#c5a059]/80">
                    AVAILABLE VALUE
                  </span>
                  <span className="text-2xl font-black tracking-tighter text-[#fef9f3] leading-none mt-1">
                    {Number(vault.balance || 0).toLocaleString("en-IN", {
                ...
                >
                  {vault.payment_verified === false ? (
                    <div className="flex items-center gap-1.5 px-3 py-1 bg-[#c5a059]/10 border border-[#c5a059]/30 rounded-full text-[#c5a059]">
                  ...
                  <button
                    ...
                    className="p-1.5 hover:bg-white/10 rounded-md transition-all text-[#c5a059]/80 hover:text-white"
                  >
                    <Eye
                      size={13}
                      className={showCardNumber ? "text-amber-400" : ""}
                    />
                  </button>
                </div>
              </div>
              ...
              {/* Card Number & Dots */}
              <div
                className="font-mono text-sm tracking-[0.1em] text-[#fef9f3]/90 mt-1 select-all"
                onClick={(e) => e.stopPropagation()}
              >
                {showCardNumber ? (
              ...
              <div className="flex items-end justify-between pt-1">
                <div className="flex flex-col gap-1 w-full">
                  <div className="flex items-center gap-5">
                    <div className="flex flex-col">
                      <span className="text-[5px] font-bold uppercase tracking-widest text-[#c5a059]/60 leading-none">
                        &nbsp;
                      </span>
                      <span className="text-[9px] font-mono text-[#fef9f3] mt-0.5 leading-none">
                        {vault.card_number?.slice(-4) || "2023"}
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[5px] font-bold uppercase tracking-widest text-[#c5a059]/60 leading-none">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-[0.05em] text-[#fef9f3]/90 mt-0.5 leading-none truncate max-w-[100px]">
                        {userName}
                      </span>
                    </div>
                  </div>
                  <span className="text-[5px] font-black uppercase tracking-[0.15em] text-[#c5a059] mt-1 leading-none">
                    0% INTEREST CREDIT
                  </span>
                </div>
                ...
                >
                  ...
                  <span className="text-[8px] font-black text-white mt-0.5 uppercase tracking-wider leading-none">
                    OPEN SCORE
                  </span>
                </div>
              </div>
        ...
        >
          <div className="bg-[#0f1113] rounded-xl text-white h-full relative overflow-hidden border-[#2a2d33] border-[0.5px] shadow-2xl flex flex-col group">
            ...
            <div className="px-5 py-4 flex-1 flex flex-col">
              <div className="flex justify-between items-start mb-2">
                <div className="space-y-1">
                  <div className="w-16 h-4 bg-white/5 rounded-sm border border-white/5 flex items-center justify-center">
                    <span className="text-[5px] font-black text-white/30 uppercase tracking-widest italic">
                      Authorized Signature
                    </span>
                  </div>
                  <div className="w-28 h-7 bg-white/5 rounded flex items-center justify-between px-2 border border-white/10">
                    <div className="flex flex-col items-start">
                      <span className="text-[4px] font-bold text-[#c5a059] uppercase leading-none mb-0.5">
                        CVV / Secure
                      </span>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      >
                        <Eye
                          size={12}
                          className={
                            showCvc ? "text-amber-400" : "text-white/30"
                          }
                        />
                      </button>
                    </div>
                ...
                <div className="text-right">
                  <span className="text-[7px] font-black tracking-[0.2em] text-[#c5a059] uppercase leading-none">
                    Vault Matrix
                  </span>
              ...
              {activeDeposit ? (
                <div
                  className="flex-1 bg-gradient-to-r from-emerald-500/[0.08] to-teal-500/[0.03] border border-emerald-500/20 rounded-xl p-3 flex flex-col justify-between"
                  onClick={(e) => e.stopPropagation()}
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-1.5">
                    <div className="flex flex-col">
                      <span className="text-[5px] font-black text-white/40 uppercase tracking-widest">
                        Lock Duration
                      </span>
                      <span className="text-[10px] font-black text-white mt-0.5">
                        {activeDeposit.tenure_days} Days
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[5px] font-black text-white/40 uppercase tracking-widest">
                      ...
                      <span className="text-[10px] font-black text-emerald-400 mt-0.5">
                        ...
                        {parseFloat(
                          parseFloat(
                            String(activeDeposit.interest_rate),
                          ).toFixed(1),
                        )}
                        %
                      </span>
                    ...
                    <div className="flex flex-col text-right">
                      <span className="text-[5px] font-black text-[#c5a059]/80 uppercase tracking-widest">
                        Total Increment
                      </span>
                ...
                <div
                  className="flex-1 overflow-y-auto scrollbar-hide flex flex-wrap gap-1.5 py-1"
                  onClick={(e) => e.stopPropagation()}
                >
                  {rates.slice(0, 4).map((r) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-black text-[#c5a059] leading-none">
                        {parseFloat(
                          parseFloat(String(r.interest_rate)).toFixed(1),
                        )}
                        %
                      </span>
                    </div>
              ...
              <div className="mt-1 flex items-center justify-between border-t border-white/[0.03] pt-2">
                <div className="flex flex-col">
                  <span className="text-[5px] font-serif italic text-white/10 uppercase tracking-widest">
                    Secured by Open Score protocol
                  </span>
                  <span className="text-[4px] font-bold text-white/5 uppercase mt-0.5">
