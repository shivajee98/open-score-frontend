...
export default function LoanHistory() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 p-4 pb-24">
            <button onClick={() => navigate('/customer/loan')} className="mb-6 flex items-center gap-2 text-slate-500 font-bold text-[10px] uppercase tracking-[0.2em] hover:text-slate-900 transition-colors">
                ...
                <div className="space-y-4">
                    {loans.map((loan, idx) => (
                        <div
                            ...
                            onClick={() => navigate(`/customer/loan/status/${loan.id}`)}
