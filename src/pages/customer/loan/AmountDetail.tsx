...
export default function LoanDetail() {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                navigate(`/customer/loan/status/${data.id || data.loan_id || 'L-10293'}`);
            }, 3000);
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans pb-32">
            ...
            <div className="bg-slate-900 p-4 pb-24 rounded-b-[2rem]">
                <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-widest hover:text-white transition-colors">
