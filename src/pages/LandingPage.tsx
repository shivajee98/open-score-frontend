...
export default function LandingPage() {
  ...
  const redirectUser = (user: any) => {
    ...
    if (!user.is_onboarded) {
      if (user.role === 'MERCHANT') navigate('/auth/merchant-onboarding');
      else navigate('/auth/onboarding');
      return;
    }
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoFocus
                    value={mobile}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMobile(e.target.value.replace(/[^0-9]/g, '').slice(0, 10))}
