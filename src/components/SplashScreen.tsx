    ...
    return (
        <div className="fixed inset-0 z-50 bg-white flex flex-col items-center justify-center animate-out fade-out duration-1000 fill-mode-forwards">
            <div className="relative mb-8">
                <div className="w-24 h-24 bg-blue-600 rounded-3xl flex items-center justify-center shadow-xl shadow-blue-600/30 animate-bounce">
            ...
            <h1 className="text-3xl font-black text-slate-900 tracking-tighter mb-2 animate-in slide-in-from-bottom-4 fade-in duration-700 delay-300">
                OpenScore
            </h1>
