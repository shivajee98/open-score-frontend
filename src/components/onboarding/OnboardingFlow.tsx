                ...
                >
                    <div className="relative group">
                        <div className="w-48 h-48 bg-slate-50 rounded-full flex items-center justify-center relative overflow-hidden">
                            <Building2 className="w-24 h-24 text-primary opacity-20" />
                            <div className="absolute inset-0 flex items-center justify-center animate-pulse">
                                <Package className="w-16 h-16 text-primary absolute -top-4 -left-4 animate-[float_3s_ease-in-out_infinite]" />
                                <Zap className="w-12 h-12 text-accent absolute top-1/2 -right-8 animate-[float_4s_ease-in-out_infinite_500ms]" />
                                <ShieldCheck className="w-14 h-14 text-primary absolute -bottom-4 left-1/2 animate-[float_3.5s_ease-in-out_infinite_1s]" />
                            </div>
                        </div>
                    </div>
                </StepContainer>
            ...
            return (
                ...
                >
                    <div className="flex flex-col items-center gap-6">
                        <div className="text-6xl font-black text-primary animate-[outline-to-solid_1s_ease-out_forwards]">
                            0%
                        </div>
                ...
                >
                    <div className="w-full max-w-[240px] space-y-4">
                        <div className="h-4 bg-slate-100 rounded-full overflow-hidden relative">
                            ...
                            <div className="absolute inset-y-0 left-0 bg-primary w-2/3 rounded-full animate-[grow-width_1.5s_ease-out_forwards]" />
                            <div className="absolute top-1/2 left-2/3 -translate-y-1/2 w-6 h-6 bg-white border-4 border-primary rounded-full shadow-lg" />
                        </div>
                    ...
                    <div className="w-full space-y-8 pl-4">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-4 relative">
                                ...
                                <div className="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center text-xs font-bold shrink-0 animate-in zoom-in duration-300" style={{ animationDelay: `${i * 300}ms` }}>
                                    {item.step}
                                </div>
