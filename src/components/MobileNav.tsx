...
export default function MobileNav() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-slate-200 p-2 md:hidden z-50 flex justify-around items-center pb-safe ring-1 ring-slate-900/5 shadow-[0_-8px_30px_rgb(0,0,0,0.04)]">
            <Link href="/customer" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer' ? (isMerchant ? 'text-emerald-600 bg-emerald-50' : 'text-blue-600 bg-blue-50') : 'text-slate-400 hover:text-slate-600'}`}>
            ...
            {isMerchant ? (
                <>
                    <Link href="/customer/qr" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer/qr' ? 'text-emerald-600 bg-emerald-50' : 'text-slate-400'}`}>
                    ...
                    <Link href="/customer/transactions" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer/transactions' ? 'text-emerald-600 bg-emerald-50' : 'text-slate-400'}`}>
                    ...
                    <Link href="/customer/profile" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer/profile' ? 'text-emerald-600 bg-emerald-50' : 'text-slate-400'}`}>
                ...
                <>
                    <Link href="/customer/loan" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname.includes('/customer/loan') ? 'text-blue-600 bg-blue-50' : 'text-slate-400'}`}>
                    ...
                    <Link href="/customer/transactions" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer/transactions' ? 'text-blue-600 bg-blue-50' : 'text-slate-400'}`}>
                        <Wallet size={22} className={pathname === '/customer/transactions' ? 'scale-110' : ''} strokeWidth={pathname === '/customer/transactions' ? 3 : 2} />
                        <span className="text-[9px] font-black uppercase tracking-widest">Wallet</span>
                    </Link>

                    <Link href="/customer/loan/history" className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-all duration-300 ${pathname === '/customer/loan/history' ? 'text-blue-600 bg-blue-50' : 'text-slate-400'}`}>
